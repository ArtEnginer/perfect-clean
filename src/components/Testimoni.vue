<template>
  <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
    <div class="container mx-auto max-w-2xl lg:max-w-4xl text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Testimonials</h2>
      <p class="mt-2 text-lg font-medium text-gray-500 sm:text-xl italic">What our customers are saying about us.</p>
    </div>
    <div
